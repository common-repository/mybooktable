...
Contributors: stormhill, authormedia, zookatron, neovita
...
You can find a **live demo** of MyBookTable in action [here](https://www.stormhillmedia.com/book-table/ "MyBookTable Demo").
...
= 3.5.2 =
fixed bug in book overview section.

= 3.5.1 =
fixed bug in buybutton admin after enhanced security update.

= 3.5.0 =
Added Nonces where needed for enhanced security.

= 3.4.0 =
Added checkbox in Settings >> Earn to "Use Amazon Attribution Links instead of affiliate links".

= 3.3.9 =
Fixed some issues with API system

= 3.3.8 =
added extra escaping in some book fields to better prevent XSS

= 3.3.7 =
fixed conflict with MBT Pro and Dev created in previous update

= 3.3.6 =
fixed importing of images with MyBookTable Import/Export

= 3.3.5 =
fixed additional issues with nonce in admin pages

= 3.3.4 =
fixed issues with nonce in admin pages

= 3.3.3 =
fixed compatibility issues with PHP8
Verified compatibility with Wordpress 6.02

= 3.3.2 =
fixed compatibility issues with Yoast 17

= 3.3.1 =
Verified compatibility with Wordpress 5.8

= 3.3.0 =
Updated some functions for compatibility with php 7.x

= 3.2.9 =
fixed JQuery bug in frontend.js.

= 3.2.8 =
Improved scroll to order button issue on book single pages in beautiful page view.

= 3.2.7 =
Fixed scroll to order button issue on book single pages in beautiful page view.

= 3.2.6 =
Made improvements to Social Media buttons. We also removed the GooglePlus button.

= 3.2.5 =
Branding changes and minor style enhancements.
...
* Removed feature links connected with Amazon API.

= 3.2.3 =
* Updated plugin contributors and repository links.

= 3.2.2 =
* Fixed an issue with certain fields on the help page not being escaped properly.

= 3.2.1 =
* Fixed an issue causing links for authors, genres, and series to not be generated properly.
* Fixed an issue causing Apple Books urls to incorrectly not be shown on the book page in certain circumstances

= 3.2.0 =
* Added new Gutenburg Blocks for MyBookTable shortcodes
* Fixed an issue that caused MyBookTable pages to show errors on the Google Structured Data Testing Tool
* Fixed an issue causing example books to be generated without the proper tags
* Fixed an issue causing Apple Books urls to incorrectly show "Invalid product link" errors

= 3.1.6 =
* Added ability to use Amazon Affiliates without a MyBookTable Upgrade
* Updated Apple Books buttons to match updated compliance standards from Apple
* Added new content to Help page and fixed issue with videos not showing up under certain conditions
* Minor functionality improvements to Book Blurb editor

= 3.1.5 =
* Fixed an issue preventing paragraph breaks in book blurbs
* Updated iTunes Buy Button graphics to comply with new guidelines from Apple
* Added "Force Grid Mode" option to All Books shortcode to bring in line with other shortcodes
